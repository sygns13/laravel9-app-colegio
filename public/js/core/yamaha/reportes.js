...
createApp({
    data() {
        return {
            tituloHeader: "Cotizaciones",
            subtituloHeader: "Reportes",
            subtitulo2Header: "Cotizaciones",
    ...
    created: function() {
        this.fillobject.fechaIni = fechaHoy;
        this.fillobject.fechaFin = fechaHoy;
    },
    mounted: function() {
    },
    computed: {
    ...
    methods: {
        ...
        buscarDatos: function(page) {
            var fechaIni = this.fillobject.fechaIni;
            var fechaFin = this.fillobject.fechaFin;
            var year = this.fillobject.year;
            var numero = this.fillobject.numero;
            var tipo_documento_id = this.fillobject.tipo_documento_id;
            var documento = this.fillobject.documento;

            var url = 'recotizacion?page=' + page + '&fechaIni=' + fechaIni + '&fechaFin=' + fechaFin + '&year=' + year + '&numero=' + numero + '&tipo_documento_id=' + tipo_documento_id + '&documento=' + documento; 
        ...
        exportarExcel: function() {
            ...
            url = 'reportexls/export?fechaIni=' + fechaIni + '&fechaFin=' + fechaFin + '&year=' + year + '&numero=' + numero + '&tipo_documento_id=' + tipo_documento_id + '&documento=' + documento; 
            //console.log(url);
            //window.open(url, '_blank').focus();
            window.location.href = url;
        },
