...
createApp({
    data() {
        return {
            tituloHeader: "Elaborar Cotizaciones",
            subtituloHeader: "Módulo",
            subtitulo2Header: "Elaborar Cotizaciones",
            ...
            labelBtnSave: 'Complete el siguiente Formulario para Generar una nueva Cotización',
    ...
    methods: {
        ...
        buscarModelo: function() {
            if(this.fillobject.maestro_modelo_id != null && this.fillobject.maestro_modelo_id != "0" ){
                ...
                var url = 'remaestromodelo/buscar/' + this.fillobject.maestro_modelo_id;
        ...
        calcularPrecioFinal: function() {
            ...
            var num1 = parseFloat(this.fillobject.precio_usd);
            var num2 = parseFloat(this.fillobject.descuento_usd );
            ...
            if (isNaN(num2)) {
                this.fillobject.precio_final_usd = num1.toFixed(2);
            }
            ...
            this.fillobject.precio_final_usd = resultado.toFixed(2);
        },
        ...
        confirmRegistrar:function () {
            swal.fire({
                title: '¿Estás seguro?',
                text: "Desea Confirmar el Registro de la Cotización",
                icon: 'info',
        ...
        confirmCotizar:function () {
            swal.fire({
                title: '¿Estás seguro?',
                text: "Desea Confirmar la Generación de la Cotización",
                icon: 'info',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
            ...
            */
            ...
            axios.post(url, this.fillobject).then(response=>{
                ...
                if(response.data.result=='1'){
                    this.errors=[];
                    this.cancelar();
                    toastr.success("La Cotización se ha Generado con éxito, iniciará la descarga en breve", {timeOut: 20000});
                    this.imprimirCotización(response.data.cotizacion.id);
                }else{
                    $('#'+response.data.selector).focus();
                    toastr.error(response.data.msj, {timeOut: 20000});
                }
