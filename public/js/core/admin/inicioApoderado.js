...
createApp({
    ...
    methods: {
        ...
        getDatos: function() {
            ...
            var url = 'admin/reapoderadomain';
            this.verApoderado = false;
            //var url2 = 'admin/reapoderadodocumentos';

            axios.get(url).then(response => {

                this.apoderado = response.data.apoderado;
                this.apoderadoEdit = response.data.apoderado;

                this.user = response.data.user;
                this.userEdit = response.data.user;

                this.apoderadoUsers = response.data.apoderadoUsers;

                this.verApoderado = true;
            })

           /*  axios.get(url2).then(response => {
                this.apoderadoUsers = response.data;
            }) */
        },
        ...
        updateFotoPerfil: function() {
            var url='admin/reapoderadoUpdate/FotoPerfil';
       ...
       /*  getDatos: function(page) {
            ...
            axios.get(url).then(response => {
                ...
                this.apoderadoUsers= response.data.apoderadoUsers.data;
                ...
                if(this.apoderadoUsers.length==0 && this.thispage!='1'){
