<div class="modal" id="modalFormulario">
  ...
  <div class="modal" id="modalFormularioI">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">@{{labelBtnSave}} Indicador</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
            <form class="form-horizontal">
                <div class="card-body">
                  <div class="form-group row">
                    <label for="txtnombreI" class="col-sm-2 col-form-label">Nombre</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="txtnombreI" placeholder="Nombre" v-model="fillobject3.nombre" maxlength="500">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="txtordenI" class="col-sm-2 col-form-label">Orden de Impresión</label>
                    <div class="col-sm-10">
                      <input type="number" class="form-control" id="txtordenI" placeholder="1" v-model="fillobject3.orden" maxlength="10">
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
        ...
        <div class="modal-footer justify-content-between">
          <button id="btnGuardarI" type="button" class="btn btn-default" data-dismiss="modal" @click="cerrarFormI()"><span class="fas fa-power-off"></span> Cerrar</button>
          <button id="btnCloseI" type="button" class="btn btn-primary" @click="procesarI()"><span class="fas fa-save"></span> @{{labelBtnSave}}</button>
        </div>
      </div>
      <!-- /.modal-content -->
    </div>
