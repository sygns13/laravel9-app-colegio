<div class="col-md-12" v-if="divFormularioGestionAlumno">
    <div class="row">
      <div class="col-md-12">
            ...
            <div class="bs-stepper">
              ...
              <div class="bs-stepper-content">
                ...
                <div id="primero-part" class="content" role="tabpanel" aria-labelledby="primero-part-trigger">
                  ...
                  <button v-if="alumno.type == 'C'" id="btnCerrarL" type="button" class="btn btn-danger" @click="cerrarFormAlumnoGestion()" style="float:right;"><span class="fas fa-power-off"></span> Cerrar</button>
                  <button v-if="alumno.type == 'U'" id="btnCerrarL" type="button" class="btn btn-danger" @click="cerrarFormAlumnoEditGestion()" style="float:right;"><span class="fas fa-power-off"></span> Cerrar</button>
                </div>
                ...
                <div id="apoderado-part" class="content" role="tabpanel" aria-labelledby="apoderado-part-trigger">
                  ...
                  <button class="btn btn-primary" @click="atrasNuevoAlumno()" style="margin-right: 10px;"><span class="fas fa-angle-left right"></span> Atras</button>
                  {{-- <button class="btn btn-primary" @click="siguienteNuevoAlumno()">Siguiente <span class="fas fa-angle-right right"></span></button> --}}
                  <button style="margin-right:5px;" id="btnSave" type="button" class="btn btn-success" @click="procesarAlumnoGestion()"><span class="fas fa-save"></span> @{{labelBtnSaveAlumno}}</button>
