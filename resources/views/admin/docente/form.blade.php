      ...
      <form>
        <div class="card-body">
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="form-group">
                  <label for="cbutipo_documento_id">Tipo de Documento de Identidad</label>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label for="txtnum_documento">Número de Documento de Identidad</label>
                  <input type="text" class="form-control" id="txtnum_documento" placeholder="Documento de Identidad" v-model="fillobject.num_documento" maxlength="25">
                </div>
              </div>

              <div class="col-md-4">
                <div class="form-group">
                  <label for="txtcodigo_plaza">Código de Plaza de Docente</label>
              ...
              <div class="col-md-2">
                <div class="form-group">
                  <label for="cbugenero">Género</label>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="txtemail" placeholder="Email" v-model="fillobject.email" maxlength="255">
                </div>
              </div>
            </div>
            ...
            <div class="row" v-if="fillobject.type=='U'">
              <div class="col-md-6">
                <div class="form-group">
                  <label for="cbumodifPsw">¿Modificar Password?</label>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label for="cbuactivo">Estado del Docente</label>
