            ...
            @if(!$cicloActivo)
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Asignación de Tutores</h3>
                                                        ...
                                                        <div role="tabpanel"
                                                            ...
                                                            <div class="form-group row">
                                                              ...
                                                              <div v-if="grado.seccions.length > 0 && seccionSeleccionada > 0">
                                                                <div class="form-group row">
                                                                    <label for="txtTutor" class="col-sm-2 col-form-label">Tutor Asignado:</label>
                                                                    <label class="col-sm-10 col-form-label" v-if="seccionSelect.tutor != null"> @{{seccionSelect.tutor.apellidos}}, @{{seccionSelect.tutor.nombre}}</label>
                                                                    <label class="col-sm-10 col-form-label" v-else>La Sección No Tiene Tutor Asignado</label>
                                                                </div>

                                                                <x-adminlte-button @click="asignarTutor()" id="btnAsignar" class="bg-gradient btn-sm" type="button" label="Asignar Tutor" theme="primary" icon="fas fa-user-secret"
                                                                                            data-placement="top" data-toggle="tooltip" title="Asignar Docente" v-if="seccionSelect.tutor_id == null" style="margin-right: 5px;"/>

                                                                <x-adminlte-button @click="asignarTutor()" id="btnAsignar" class="bg-gradient btn-sm" type="button" label="Asignar Tutor" theme="warning" icon="fas fa-user-secret"
                                                                                            data-placement="top" data-toggle="tooltip" title="Modificar Asignación" v-if="seccionSelect.tutor_id != null" style="margin-right: 5px;"/>

                                                                <x-adminlte-button @click="borrarAsignacion()" id="btnBorrar" class="bg-gradient btn-sm" type="button" label="Eliminar Asignación" theme="danger" icon="fas fa-trash"
                                                                                            data-placement="top" data-toggle="tooltip" title="Eliminar Asignación de Tutor" v-if="seccionSelect.tutor_id != null" style="margin-left: 5px;"/>
