  <div class="col-md-12" v-if="divFormulario">
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title">@{{labelBtnSave}} Hora del Turno @{{turnoNombre}}</h3>
      </div>
          ...
          <form class="form-horizontal">
            <div class="card-body">
              <div class="form-group row">
                <label for="txthoraini" class="col-sm-2 col-form-label">Hora de Inicio</label>
                <div class="col-sm-2">
                  <input type="time" class="form-control" id="txthoraini" placeholder="00:00" v-model="fillobject.horaini">
                </div>
              </div>
              <div class="form-group row">
                <label for="txthorafin" class="col-sm-2 col-form-label">Hora de Finalización</label>
                <div class="col-sm-2">
                  <input type="time" class="form-control" id="txthorafin" placeholder="00:00" v-model="fillobject.horafin" maxlength="10">
                </div>
              </div>
              <div class="form-group row">
                <label for="cbutipo" class="col-sm-2 col-form-label">Tipo de Hora</label>
                <div class="col-sm-4">
                  <select class="form-control" style="width: 100%;" v-model="fillobject.tipo" id="cbutipo">
                    <option value="1">Hora Lectiva</option>
                    <option value="0">Hora de Recreo</option>
                  </select>
                </div>
              </div>
            </div>
