        ...
        <div class="col-md-12">
          <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Matrículas de Alumnos Bajo su Custodia</h3>
                        ...
                        <tbody>
                            <tr v-for="(registro, indexS) in registros">
                                ...
                                <td class="rows-table">
                                    ...
                                    {{-- <x-adminlte-button v-if="registro.estado=='5' && (registro.validado_apoderado == null || registro.validado_apoderado == '0')" @click="validarMatricula(registro)" id="btnValidar" class="bg-gradient btn-sm" type="button" label="" theme="primary" icon="fas fa-check-circle"
