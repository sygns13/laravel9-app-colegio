                        ...
                        <table class="table table-bordered table-sm">
                            <thead>
                                <tr>
                                    ...
                                    <th class="titles-table" style="width: 13%">Empresa</th>
                                    <th class="titles-table" style="width: 10%">Documento de Identidad</th>
                                    <th class="titles-table" style="width: 15%">Nombres y Apellidos</th>
                                    <th class="titles-table" style="width: 8%">Celular</th>
                                    <th class="titles-table" style="width: 10%">Username</th>
                                    <th class="titles-table" style="width: 15%">Email</th>
                            ...
                            <tbody>
                                <tr v-for="(registro, indexS) in registros">
                                    ...
                                    <td class="rows-table">@{{registro.empresa}}</td>
                                    <td class="rows-table">@{{registro.tipo_documentos_sigla}}: @{{registro.documento}}</td>
                                    <td class="rows-table">@{{registro.nombres}} @{{registro.apellidos}}</td>
                                    <td class="rows-table">@{{registro.celular}}</td>
