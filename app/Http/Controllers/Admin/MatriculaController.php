...
class MatriculaController extends Controller
{
    ...
    public function getMatriculaActiva($alumno_id)
    {
        ...
        if($matricula == null){
            return response()->json(["result"=>'0','msj'=>"Matricula no encontrada",'matricula'=>null]);
        }

        return response()->json(["result"=>'1','msj'=>"",'matricula'=>$matricula]);
    }
    ...
    public function store(Request $request)
    {
        ...
        if($segureFile==1){
            ...
            if(0 == intval($alumno->estado_grado)){
