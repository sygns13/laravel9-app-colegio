...
class MatriculaController extends Controller
{
    ...
    public function index7()
    {
        ...
        return view('alumno.consultar-matricula.index',compact('mensajes','ciclos','cicloActivo', 'estados', 'departamentos', 'provincias', 'distritos', 'niveles', 'grados','secciones'));
    }
    ...
    public function indexGetAlumno(Request $request)
    {
        $result='1';
        $msj='';
        $selector='';
