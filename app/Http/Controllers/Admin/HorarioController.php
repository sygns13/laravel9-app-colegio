...
class HorarioController extends Controller
{
    ...
    public function index4()
    {
        ...
        return view('apoderado.horario.index',compact('cicloActivo', 'ciclos', 'mensajes'));
    }
    ...
    public function index5()
    {
        ...
        return view('alumno.rephorario.index',compact('cicloActivo', 'ciclos', 'mensajes'));
    }
    ...
    public function indexApoHorario(Request $request)
    {

        $iduser =Auth::user()->id;
        $ciclo_id = $request->ciclo_id;

        $registros = Horario::GetApoderadoDataHorarioActivo($ciclo_id, $iduser);
    ...
    public function indexAluHorario(Request $request)
    {

        $iduser =Auth::user()->id;
        $ciclo_id = $request->ciclo_id;

        $registros = Horario::GetAlumnoDataHorarioActivo($ciclo_id, $iduser);
