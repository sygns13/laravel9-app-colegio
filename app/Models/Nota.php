...
class Nota extends Model
{
    ...
    public static function GetItemsNotasAlumnosDoc($ciclo_id){
        ...
        if($ciclo){
            ...
            foreach ($niveles as $key => $nivel) {
                ...
                $grados = DB::select("select cg.id, cg.orden, cg.nombre, cg.ciclo_niveles_id, ac.docente_id from asignacion_cursos as ac
                            ...
                            group by cg.orden
                            order by cg.orden;", [$docente->id, $ciclo_id, $nivel->id]);
                    ...
                    foreach ($seccions as $keyS => $valueS) {
                        ...
                        $matriculas =DB::table('matriculas')
                            ...
                            foreach ($matriculas as $keyMat => $matricula) {
                                ...
                                and 
                                sec.id = ?
                                order by sec.id, cur.orden;", [$docente->id, $ciclo_id, $valueG->id, $valueS->id]);
    ...
    public static function GetItemsNotasAlumnosApo($ciclo_id){
        ...
        if($ciclo){
            ...
            foreach ($apoderadoUsers as $key => $apoderado) {
                ...
                $matricula = Matricula::where('alumno_id', $alumno->id)->where('ciclo_escolar_id', $ciclo->id)->first();
            ...
            if(count($idCicloSecciones) > 0 ){
                ...
                foreach ($niveles as $key => $nivel) {
                    ...
                    $grados = DB::select("select cg.id, cg.orden, cg.nombre, cg.ciclo_niveles_id from  ciclo_seccion cs
                                ...
                                ".$WhereAlumnos."
                                group by cg.id
                                order by cg.orden;", [$ciclo_id, $nivel->id]);
                    ...
                    foreach ($grados as $keyG => $valueG) {
                        ...
                        foreach ($seccions as $keyS => $valueS) {
                            ...
                            $matriculas =DB::table('matriculas')
                                    ...
                                    ->whereIn('matriculas.id', $matriculasIds)
                                    ->orderBy('alumnos.apellido_paterno')
                                    ->orderBy('alumnos.apellido_materno')
                                    ->orderBy('alumnos.nombres')
                                    ->orderBy('matriculas.id')
    ...
    public static function GetItemsNotasAlumnosAlu($ciclo_id){
        ...
        if($ciclo){
            ...
            $matricula =DB::table('matriculas')
                                ...
                                ->select('matriculas.id',
                                    ...
                                    'matriculas.aprecia_tutor_1',
                                    'matriculas.aprecia_tutor_2',
                                    'matriculas.aprecia_tutor_3',
